...
#     data8 = handle.read()
#
# # loads all of the data from the files into dictionaries
...
#
# # joins all of the dictionaries into one dictionary to store the data from the files
# all_data = {}
# all_data.update(d1)
# all_data.update(d2)
# all_data.update(d3)
...
# # the value for each key is a list of tuples of each row containing each value for each data entered in each column
